...
namespace SixLabors.Fonts.Tables.General.CMap
{
    ...
    {
        public PlatformEncodingID PlatformID { get; }
        public ushort EncodingID { get; }
        public uint Offset { get; }

        public EncodingRecord(PlatformEncodingID platformID, ushort encodingID, uint offset)
        {
        ...
        {
            var platform = (PlatformEncodingID)reader.ReadUInt16();
